...
import me.sosedik.miscme.impl.item.modifier.HiddenCursesModifier;
...
import me.sosedik.miscme.impl.item.modifier.NoCurseGlintModifier;
import me.sosedik.miscme.impl.item.modifier.RedCurseNameModifier;
...
public final class MiscMe extends JavaPlugin {
	...
	public void onEnable() {
		...
		new HiddenCursesModifier(miscMeKey("hidden_curses")).register();
		new LunarClockModifier(miscMeKey("lunar_clock")).register();
		new LuxmeterModifier(miscMeKey("luxmeter")).register();
		new NoCurseGlintModifier(miscMeKey("no_curse_glint")).register();
		new RedCurseNameModifier(miscMeKey("red_curse_name")).register();
