...
public record BowData(
	...
	public static BowData fromBow(ItemStack bow, @Nullable ItemStack arrow) {
		return NBT.get(bow, nbt -> {
			...
			return new BowData(material, base, string, modifier, arrow == null ? null : ArrowData.fromArrow(arrow));
		});
	}

	public static BowData defaultData(@Nullable ArrowData arrowData) {
		return new BowData(null, null, null, null, arrowData);
	}
